...
<html>
    ...
    <div class="form">
        ...
        <form action="HistorialServlet" >
            ...
            <input type="submit" id="enviar" class="button-estilo" value="Reservar" onclick="alert('Gracias por tu reserva')">
                <br>
                <a href="asfaMain.jsp"><input class="button-est" name="mysubmit" value="Reservar otros" /></a>
